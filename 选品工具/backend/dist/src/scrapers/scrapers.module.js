...
const google_trends_scraper_1 = require("./google-trends.scraper");
...
exports.ScrapersModule = ScrapersModule = __decorate([
    (0, common_1.Module)({
        providers: [google_trends_scraper_1.GoogleTrendsScraper],
        exports: [google_trends_scraper_1.GoogleTrendsScraper],
    })
], ScrapersModule);
